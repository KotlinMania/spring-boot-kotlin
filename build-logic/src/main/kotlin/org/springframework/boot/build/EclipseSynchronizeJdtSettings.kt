...
/**
 * [Task] to synchronize Eclipse JDT settings.
 * 
 * @author Phillip Webb
 */
abstract class EclipseSynchronizeJdtSettings : PropertiesGeneratorTask<EclipseSynchronizeJdtSettings.Configuration?>() {
    ...
    internal class Configuration(transformer: PropertiesTransformer?) :
