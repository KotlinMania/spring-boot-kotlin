 ...
 */
enum class ArchitectureCheckAnnotation {
    /**
    ...
    companion object {
        private val annotationNameToClassName: MutableMap<String?, String?> = Map.of<String?, String?>(
        ...
        fun classFor(
            annotationProperty: MutableMap<String?, String?>,
            annotation: ArchitectureCheckAnnotation
        ): String? {
