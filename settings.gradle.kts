...
pluginManagement {
    ...
    resolutionStrategy {
        eachPlugin {
            ...
            // Dokka: modules apply `id "org.jetbrains.dokka"` bare (version came from
            // Spring's buildSrc classpath). Inject the version centrally here.
...
// === PARKED: full module list. Re-enable incrementally as each is converted. ===
